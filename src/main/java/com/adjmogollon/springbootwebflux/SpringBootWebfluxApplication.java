package com.adjmogollon.springbootwebflux;

import java.util.Date;

import com.adjmogollon.springbootwebflux.models.dao.ProductoDao;
...
public class SpringBootWebfluxApplication implements CommandLineRunner  {
	...
	private static final  Logger log = (Logger) LoggerFactory.getLogger(SpringBootWebfluxApplication.class);
